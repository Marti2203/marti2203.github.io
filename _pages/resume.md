...
* Jul 2020 - Aug 2022: **ANTLR Software Consultant**, Kruggle
  * Migrated grammars from ANTLRv3 to ANTLRv4; investigated performance/memory issues; added new grammars (Scala, Swift, Kotlin, Objective-C, Go, COBOL, ABAP)
...
Skills
======
* Automated program repair and program analysis
* Large language models for code generation, agentic systems, and security
* Fuzzing and vulnerability detection (protocol fuzzing, OSS-Fuzz)
* Compiler/grammar engineering (ANTLR)

Selected Publications & Tools
======
* [AutoCodeRover](/publication/2026-07-01-autocoderover-agentic-program-repair-sonarqube): agentic program repair for SonarQube issues (FSE 2026, Industry Paper)
* [ChatAFL](/portfolio/2024-02-26-chatafl): LLM-guided protocol fuzzing (NDSS 2024)
* [Cerberus](/portfolio/2023-05-14-cerberus): unified program analysis/repair framework (ICSE 2023, Tool Demonstrations Track)
* [Fixing Security Vulnerabilities with Agentic AI in OSS-Fuzz](/publication/2026-04-01-fixing-security-vulnerabilities-with-agentic-ai-in-oss-fuzz) (ICSE 2026)
* [Automated Repair of Programs from Large Language Models](/publication/2023-05-14-automated-repair-of-programs-from-large-language-models) (ICSE 2023, Research Track)

Full list on the [publications](/publications/) page or [Google Scholar]({{ site.author.googlescholar }}).
